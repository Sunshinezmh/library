(function() {
    ...
    angular
        .module('library')
        .controller('JedMetricsMonitoringModalController', JedMetricsMonitoringModalController);

    JedMetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function JedMetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
