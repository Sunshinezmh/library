...
if(typeof url == "string"){
  let str = url.substring(0,url.indexOf("/"));
    switch (str){
      ...
      //   break;
      default:
        url = " http://192.168.22.153:8080/library/resources/" + url;
        break;
    }
  ...
  let str = url.url.substring(0,url.url.indexOf("/"));
   switch (str){
      ...
      //   break;
      default:
      // http://192.168.22.153:8080/library
     
        url.url = "http://192.168.22.153:8080/library/resources/" + url.url;
        break;
    }
}
  ...
  public  getExportExcelUrl(url:string){
